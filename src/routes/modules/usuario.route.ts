...
import { PrismaUsuarioRepository, PrismaDireccionRepository } from '../../repositories/prisma/PrismaAuthRepository';

const upload = multer();
const usuarioRepository = new PrismaUsuarioRepository();
const direccionRepository = new PrismaDireccionRepository();
const usuarioService = new UsuarioService(usuarioRepository, direccionRepository);
